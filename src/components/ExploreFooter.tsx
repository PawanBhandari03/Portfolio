...
const CARDS = [
  ...
  },
  {
    ...
    iconBg: "bg-gradient-to-br from-[#f472b6] to-[#d946ef]",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    iconBg: "bg-gradient-to-br from-[#8B5CF6] to-[#f472b6]",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section id="other" className="w-full max-w-5xl mx-auto pt-20 pb-24 px-6 relative z-10 flex flex-col gap-14">
        <div className="flex flex-col gap-3">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight">
            More to{' '}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#b388ff] to-[#f472b6]">Explore</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {CARDS.map((card, idx) => (
            ...
            >
              <div className={`w-14 h-14 rounded-2xl ${card.iconBg} flex items-center justify-center shadow-lg`}>
                {card.icon}
              </div>
              ...
              <span className={`text-sm font-semibold ${card.linkColor} mt-auto group-hover:underline`}>Explore →</span>
            </motion.a>
          ))}
        </div>
      </section>
