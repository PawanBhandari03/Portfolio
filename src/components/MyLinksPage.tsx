          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-white font-bold text-lg leading-tight">GitHub</p>
                  <p className="text-slate-400 text-sm mt-0.5">github.com/PawanBhandari03</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-slate-400 text-sm mt-0.5">in/pawan-singh-bhandari-5817ab307</p>
                </div>
              </div>
              <span className="text-slate-500 group-hover:text-[#8B5CF6] transition-colors shrink-0">
                <ExternalLinkIcon />
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <p className="text-white font-bold text-lg leading-tight">Email</p>
